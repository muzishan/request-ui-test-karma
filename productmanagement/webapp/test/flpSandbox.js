		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comkionsdruiproductmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkionsdruiproductmanagement-display": {
								"semanticObject": "comkionsdruiproductmanagement",
								"action": "display",
								"description": "Dashboard for manage product",
								"title": "Product Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kion.sdr.ui.productmanagement",
									"url": sap.ui.require.toUrl("com/kion/sdr/ui/productmanagement")
								}
							}
						}
					}
