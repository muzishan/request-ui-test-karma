		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comkionsdruimasterdata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkionsdruimasterdata-display": {
								"semanticObject": "comkionsdruimasterdata",
								"action": "display",
								"description": "Dashboard to maintain the MasterData",
								"title": "Master Data Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kion.sdr.ui.masterdata",
									"url": sap.ui.require.toUrl("com/kion/sdr/ui/masterdata")
								}
							}
						}
					}
